...
public class C1: MonoBehaviour
{
    ...
    void Start()
    {
        Creatures=Resources.LoadAll<GameObject>("C1");
        StartBuild();
    }
    void StartBuild()
    {
    ...
    void RenderComponent(GameObject[] pieceArray, float inputnum)
    {
        ...
        //GameObject clone = Instantiate(randomTransform.gameObject, this.transform.position + new Vector3 (0, inputnum, 0), transform.rotation) as GameObject;
